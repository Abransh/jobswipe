 ...
 */
export function remove(str: string, substring: string): string {
 ...
 */
export function getMostFrequentChar(str: string): string {
 ...
 */
export function findWords(str: string, pattern: RegExp): string[] {
