...
function createRedisSessionService(redisConfig, sessionConfig) {
    console.log('Creating Redis session service with config:', redisConfig);
    return new shared_1.RedisSessionService();
}
...
var servicesPlugin = function (fastify) { return __awaiter(void 0, void 0, void 0, function () {
    var config, serviceRegistry, jwtService, sessionService, securityService;
    return __generator(this, function (_a) {
        config = {
            jwt: {
        ...
        try {
            jwtService = (0, shared_1.createJwtTokenService)({
            ...
            throw new Error("JWT service initialization failed: ".concat(error));
        }
        // =============================================================================
        ...
        try {
            ...
            throw new Error("Redis session service initialization failed: ".concat(error));
        }
        // =============================================================================
        ...
        fastify.get('/health/services', {
            ...
            var servicesHealth, allHealthy, anyUnhealthy, overallStatus, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, reply.code(503).send({
                                status: 'unhealthy',
                                timestamp: new Date().toISOString(),
                                error: error_3 instanceof Error ? error_3.message : 'Service health check failed',
                            })];
