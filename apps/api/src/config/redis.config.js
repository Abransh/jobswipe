...
exports.redisConfig = {
    ...
    retryStrategy: function (times) {
        ...
        console.log("Redis reconnection attempt ".concat(times, ", waiting ").concat(delay, "ms"));
        return delay;
    },
    // Connection timeout
...
function createRedisConnection() {
    var redis = new ioredis_1.Redis(exports.redisConfig);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ Redis connection test failed:', error_1);
                    return [4 /*yield*/, redis.quit()];
                case 5:
                    _a.sent();
