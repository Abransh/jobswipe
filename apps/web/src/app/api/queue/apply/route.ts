...
export async function POST(request: NextRequest) {
  try {
    ...
    // Validate the job application request
    ...
    console.log('✅ [Queue API] Job application successful:', {
      userId: authenticatedUser.id,
      jobId,
      applicationId: application.id,
    ...
    console.error('❌ [Queue API] Job application failed:', error);
