...
export async function POST(request: NextRequest) {
  console.log('🚀 [API Route] Register request started');
  
  try {
    const body = await request.json();
    console.log('📝 [API Route] Request body:', { email: body.email, hasPassword: !!body.password, name: body.name });
    ...
    const backendUrl = `${API_BASE_URL}/v1/auth/register`;
    ...
    console.log('✅ [API Route] Register successful, returning response');
    return res;
