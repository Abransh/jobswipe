/**
 * @fileoverview Login API route for desktop app
...
export async function POST(request: NextRequest) {
  console.log('🚀 [Desktop API Route] Login request started');
  
  try {
    const body = await request.json();
    console.log('📝 [Desktop API Route] Request body:', { email: body.email, hasPassword: !!body.password });
    
    // Add source identifier for desktop requests
    const loginData = {
      ...body,
    ...
    console.log('🍪 Setting cookies for desktop app:', {
    ...
    console.log('✅ [Desktop API Route] Login successful, returning response');
    return res;

  } catch (error) {
    console.error('❌ [Desktop API Route] Login error:', error);
